...
TEST_CASE("Testing eigenvalues"){
    ...
    REQUIRE(eigen[0]==Approx(11.2909));
    REQUIRE(eigen[1]==Approx(44.6241));
    REQUIRE(eigen[2]==Approx(100.18));
}
TEST_CASE("Testing eigenvector orthogonality"){
    ...
    //test eigen vectors
    REQUIRE(eigenvec(0,0)==Approx(0.9999).epsilon(0.001));
    REQUIRE(eigenvec(0,1)==Approx(-0.0027));
    REQUIRE(eigenvec(0,2)==Approx(0.0000));
    REQUIRE(eigenvec(1,0)==Approx(-0.0027));
    REQUIRE(eigenvec(1,1)==Approx(0.9999).epsilon(0.001));
    REQUIRE(eigenvec(1,2)==Approx(-0.0017).epsilon(0.001));
    REQUIRE(eigenvec(2,0)==Approx(0.0000));
    REQUIRE(eigenvec(2,1)==Approx(-0.0017).epsilon(0.001));
